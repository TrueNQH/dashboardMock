import { faFaceLaughWink, faTachographDigital, faUsers, faHouse } from '@fortawesome/free-solid-svg-icons'
        ...
        <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li className="nav-item active">
                <Link className="nav-link" to="/portal/news-list">
                    ...
                    <FontAwesomeIcon icon="fa-solid fa-newspaper" style={{ marginRight: "0.5rem" }} />
                    <span>News</span>
                </Link>
            </li>
